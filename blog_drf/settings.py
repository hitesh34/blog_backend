...
SECRET_KEY = 'django-insecure-g*9soc-(vmc17-sj5g2gd&rjgi&t81+((qtymq^$q*48)ux@t8'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'blog_drf/home/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Add the following line to specify the STATIC_ROOT directory.
